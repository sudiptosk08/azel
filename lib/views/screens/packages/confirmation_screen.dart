...
class ConfirmationScreen extends StatefulWidget {
  ...
  const ConfirmationScreen({Key? key, required this.hotelconf})
      : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                widget.hotelconf == true ? 'Your Hotel' : 'Your Trip',
              ...
              KButton(
                kbuttonTap: () {
                  Navigator.push(
                      context, FadeRoute(page: const PaymentScreen()));
                },
                buttonimage: false,
                text: 'Continue',
