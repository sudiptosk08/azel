...
class MyTripHotelDetailsScreen extends StatefulWidget {
  final String hotelname;
  const MyTripHotelDetailsScreen({Key? key, required this.hotelname})
      : super(key: key);

  @override
  _MyTripHotelDetailsScreenState createState() =>
      _MyTripHotelDetailsScreenState();
}

class _MyTripHotelDetailsScreenState extends State<MyTripHotelDetailsScreen> {
  List<String> images = [
    AssetPath.hotel1,
    AssetPath.hotel2,
    AssetPath.hotel3,
              ...
              child: Stack(children: [
                ...
                Transform(
                  transform: Matrix4.translationValues(
                      KSize.getWidth(context, 270), -100, 0.0),
                  child: Container(
                    decoration: BoxDecoration(
                      border: Border.all(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: KButton(
                        ...
                        buttonimage: false,
                        text: 'Cancel This Hotel',
                        txtcolor: KColor.white,
                        containerColor: KColor.cardred,
