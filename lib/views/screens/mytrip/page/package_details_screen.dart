...
class MyTripPackageDetailsScreen extends StatefulWidget {
  const MyTripPackageDetailsScreen({Key? key}) : super(key: key);

  @override
  _MyTripPackageDetailsScreenState createState() =>
      _MyTripPackageDetailsScreenState();
}

class _MyTripPackageDetailsScreenState
    extends State<MyTripPackageDetailsScreen> {
  List<String> images = [
    AssetPath.user1,
    AssetPath.user2,
    AssetPath.user3,
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Transform.translate(
              offset: Offset(0, KSize.getHeight(context, -30)),
              child: Container(
                width: MediaQuery.of(context).size.width,
              ...
              child: SizedBox(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // ),
                    Transform.translate(
                      offset: Offset(KSize.getWidth(context, 0), 0),
                      child: KButton(
                        ...
                        getWidth: KSize.getWidth(context, 40),
            ...
            Center(
              child: Padding(
                padding:
                    const EdgeInsets.only(left: 25.0, bottom: 10, right: 25.0),
                child: Container(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(context,
                            FadeRoute(page: const SearchFlightsScreen()));
                      },
                      child: Text(
                        "Cancel This Trip",
                        style: KTextStyle.buttonText1
